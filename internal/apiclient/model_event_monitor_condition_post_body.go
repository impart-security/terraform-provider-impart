...
type EventMonitorConditionPostBody struct {
	// The number of times a condition must be met before the monitor is triggered.
	Threshold int32 `json:"threshold"`
	// How condition values are compared to the threshold (less than, greater than, equal to)
	Comparator string `json:"comparator"`
	// The time offset from now() in the past in milliseconds.
	Delay int64 `json:"delay"`
	// The amount of time, in milliseconds, during which the conditions must be met.
...
func (o *EventMonitorConditionPostBody) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEventMonitorConditionPostBody)
	...
	*o = EventMonitorConditionPostBody(varEventMonitorConditionPostBody)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "time_period")
