...
func (o *ApiBindingPostBody) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varApiBindingPostBody)
	...
	*o = ApiBindingPostBody(varApiBindingPostBody)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "upstream_origin")
		delete(additionalProperties, "hops")
		delete(additionalProperties, "use_forwarded")
		delete(additionalProperties, "forwarded_for")
		delete(additionalProperties, "forwarded_host")
		delete(additionalProperties, "forwarded_proto")
		delete(additionalProperties, "forwarded_id")
