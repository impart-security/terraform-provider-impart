...
func NewRulesTestCase(id string, name string, description string, required bool, messages []RulesTestCaseMessagesInner, assertions []RulesTestCaseAssertion, createdBy string, createdAt time.Time, updatedBy NullableString, updatedAt NullableTime) *RulesTestCase {
	this := RulesTestCase{}
	this.Id = id
	this.Name = name
